                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                 ...
                                                 <input class="form-control py-4" type="text" name="nama" placeholder="Masukan Nama Lengkap" />
                                            </div>
                                             <div class="form-group">
                                                 <label class="small mb-1">Email</label>
                                                 <input class="form-control py-4" type="text"  name="email" placeholder="Masukan Email" />
                                            </div>
                                             <div class="form-group">
                                                 <label class="small mb-1">No. Telepon</label>
                                                 <input class="form-control py-4" type="text" name="no_telepon" placeholder="Masukan No. Telepon" />
                                            </div>
                                             <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <input class="form-control py-4" type="text" d name="username" placeholder="Masukan username" />
                                            </div>
                                            <div class="form-group">
