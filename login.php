                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="inputEmail Address" type="text" name="username" placeholder="Enter username" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a button class="btn btn-danger" href="register.php">Register</a>
                                            </div>
                                        </form>
                                    </div>
